    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.body}>
                ...
                <Text style={[Headertext.h4, { color: Colors.fontWhite, marginTop: 20 }]}>Information We Collect</Text>
                <Text style={Headertext.h5, styles.paraText}>
                    Information we collect includes both information you knowingly and actively provide us when using or participating in any of our services and promotions, and any information automatically sent by your devices in the course of accessing our products and services.
                </Text>

                <Text style={[Headertext.h4, { color: Colors.fontWhite, marginTop: 20 }]}>Log Data</Text>
                <Text style={Headertext.h5, styles.paraText}>
                    Please be aware that while this information may not be personally identifying by itself, it may be possible to combine it with other data to personally identify individual persons.
                </Text>
                
                <Text style={[Headertext.h4, { color: Colors.fontWhite, marginTop: 20 }]}>Personal Information</Text>
                <Text style={Headertext.h5, styles.paraText}>
                    We may ask for personal information which may include one or more of the Name and Email.
                </Text>

                <Text style={[Headertext.h4, { color: Colors.fontWhite, marginTop: 20 }]}>Legitimate Reasons for Processing Your Personal Information</Text>
                <Text style={Headertext.h5, styles.paraText}>
                    We only collect and use your personal information when we have a legitimate reason for doing so. In which instance, we only collect personal information that is reasonably necessary to provide our services to you.
                </Text>
                
                <Text style={[Headertext.h4, { color: Colors.fontWhite, marginTop: 20 }]}>Collection and Use of Information</Text>
                <Text style={Headertext.h5, styles.paraText}>
                ...
                <Text style={[Headertext.h4, { color: Colors.fontWhite, marginTop: 20 }]}>Security of Your Personal Information</Text>
                <Text style={Headertext.h5, styles.paraText}>
                ...
                <Text style={[Headertext.h4, { color: Colors.fontWhite, marginTop: 20 }]}>How Long We Keep Your Personal Information</Text>
                <Text style={Headertext.h5, styles.paraText}>
                ...
                <Text style={[Headertext.h4, { color: Colors.fontWhite, marginTop: 20 }]}>Children’s Privacy</Text>
                <Text style={Headertext.h5, styles.paraText}>
                    We do not aim any of our products or services directly at children under the age of 13, and we do not knowingly collect personal information about children under 13.
                </Text>

                <Text style={[Headertext.h4, { color: Colors.fontWhite, marginTop: 20 }]}>Your Rights and Controlling Your Personal Information</Text>
                <Text style={Headertext.h5, styles.paraText}>
                ...
                <Text style={[Headertext.h4, { color: Colors.fontWhite, marginTop: 20 }]}>Changes to This Policy</Text>
                <Text style={Headertext.h5, styles.paraText}>
                ...
                <Text style={[Headertext.h4, { color: Colors.fontWhite, marginTop: 20 }]}>Contact Us</Text>
                <Text style={Headertext.h5, styles.paraText}>
